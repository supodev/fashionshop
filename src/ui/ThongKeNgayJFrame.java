 ...
 * @author vvtvo
 */
public class ThongKeNgayJFrame extends javax.swing.JFrame {

    /**
     * Creates new form ThongKeNgayJFrame
     */
    public ThongKeNgayJFrame() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        cboNgay.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongKeNgayJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void init() {
        ...
        for(int i = 1; i <= 30; i++){
            ngay = String.valueOf(i).toString();
    ...
    void fillTableHD_SP() {
        int ngay = Integer.parseInt(cboNgay.getModel().getSelectedItem().toString());
        ...
        try {
            ...
            model.setRowCount(0);
            List<Object[]> list = dao.getHD1(ngay,thang, nam);
            int stt = 1;
            for (Object[] row : list) {
        ...
        try {
            ...
            model.setRowCount(0);
            List<Object[]> list = dao.getSP1(ngay,thang, nam);
            for (Object[] row : list) {
